...
export default function AssistantSettings() {
  ...
  const [formData, setFormData] = useState({
    ...
    assistant_guidelines: user?.assistant_guidelines || 'Seja sempre prestativa, objetiva e profissional. Ajude o usuário a organizar suas tarefas e projetos de forma eficiente.\n\nQUANDO O USUÁRIO PEDIR PARA CRIAR ESTRUTURAS DE PASTAS OU ARQUIVOS:\n- Reconheça listas de pastas/arquivos (ex: "01_PASTA", "Subpasta1", etc)\n- Execute automaticamente a criação usando as ações disponíveis\n- NÃO pergunte confirmação, apenas crie tudo\n- Informe o resultado após criar',
